...
var __gwtModuleFunction = $wnd.AppWidgetset;
var $sendStats = __gwtModuleFunction.__sendStats;
$sendStats('moduleStartup', 'moduleEvalStart');
var $gwt_version = "8.12.4";
var $strongName = '';
var $gwt = {};
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.AppWidgetset=");
    idx += (13 + "AppWidgetset".length);  // 
  }
  if (idx >= 0) {
