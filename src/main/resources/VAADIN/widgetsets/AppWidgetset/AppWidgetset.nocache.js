function AppWidgetset(){
  var $intern_0 = 'bootstrap', $intern_1 = 'begin', $intern_2 = 'gwt.codesvr.AppWidgetset=', $intern_3 = 'gwt.codesvr=', $intern_4 = 'AppWidgetset', $intern_5 = 'startup', $intern_6 = 'DUMMY', $intern_7 = 0, $intern_8 = 1, $intern_9 = 'iframe', $intern_10 = 'position:absolute; width:0; height:0; border:none; left: -1000px;', $intern_11 = ' top: -1000px;', $intern_12 = 'CSS1Compat', $intern_13 = '<!doctype html>', $intern_14 = '', $intern_15 = '<html><head><\/head><body><\/body><\/html>', $intern_16 = 'undefined', $intern_17 = 'readystatechange', $intern_18 = 10, $intern_19 = 'script', $intern_20 = 'javascript', $intern_21 = 'Failed to load ', $intern_22 = 'moduleStartup', $intern_23 = 'scriptTagAdded', $intern_24 = 'moduleRequested', $intern_25 = 'meta', $intern_26 = 'name', $intern_27 = 'AppWidgetset::', $intern_28 = '::', $intern_29 = 'gwt:property', $intern_30 = 'content', $intern_31 = '=', $intern_32 = 'gwt:onPropertyErrorFn', $intern_33 = 'Bad handler "', $intern_34 = '" for "gwt:onPropertyErrorFn"', $intern_35 = 'gwt:onLoadErrorFn', $intern_36 = '" for "gwt:onLoadErrorFn"', $intern_37 = '#', $intern_38 = '?', $intern_39 = '/', $intern_40 = 'img', $intern_41 = 'clear.cache.gif', $intern_42 = 'baseUrl', $intern_43 = 'AppWidgetset.nocache.js', $intern_44 = 'base', $intern_45 = '//', $intern_46 = 'modernie', $intern_47 = 'MSIE', $intern_48 = 'Trident', $intern_49 = 'yes', $intern_50 = 'none', $intern_51 = 'user.agent', $intern_52 = 'webkit', $intern_53 = 'safari', $intern_54 = 'msie', $intern_55 = 11, $intern_56 = 'ie10', $intern_57 = 9, $intern_58 = 'ie9', $intern_59 = 8, $intern_60 = 'ie8', $intern_61 = 'gecko', $intern_62 = 'gecko1_8', $intern_63 = 2, $intern_64 = 3, $intern_65 = 4, $intern_66 = 'selectingPermutation', $intern_67 = 'AppWidgetset.devmode.js', $intern_68 = '277596AAAA0B23D1483E8D7F07A7617C', $intern_69 = ':1', $intern_70 = ':2', $intern_71 = ':', $intern_72 = '.cache.js', $intern_73 = 'loadExternalRefs', $intern_74 = 'end', $intern_75 = 'http:', $intern_76 = 'file:', $intern_77 = '_gwt_dummy_', $intern_78 = '__gwtDevModeHook:AppWidgetset', $intern_79 = 'Ignoring non-whitelisted Dev Mode URL: ', $intern_80 = ':moduleBase', $intern_81 = 'head';
  var $wnd = window;
  var $doc = document;
    ...
    function installCode(code_0){
      ...
      if (AppWidgetset.__errFn) {
        script.onerror = function(){
          AppWidgetset.__errFn($intern_4, new Error($intern_21 + code_0));
        }
        ;
      }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    values[$intern_46] = {'none':$intern_7, 'yes':$intern_8};
    providers[$intern_51] = function(){
      ...
      ())
        return $intern_53;
      if (function(){
        return ua.indexOf($intern_54) != -1 && (docMode >= $intern_18 && docMode < $intern_55);
      }
      ())
        return $intern_56;
      if (function(){
        return ua.indexOf($intern_54) != -1 && (docMode >= $intern_57 && docMode < $intern_55);
      }
      ())
        return $intern_58;
      if (function(){
        return ua.indexOf($intern_54) != -1 && (docMode >= $intern_59 && docMode < $intern_55);
      }
      ())
        return $intern_60;
      if (function(){
        return ua.indexOf($intern_61) != -1 || docMode >= $intern_55;
      }
      ())
        return $intern_62;
      return $intern_53;
    ...
    ;
    values[$intern_51] = {'gecko1_8':$intern_7, 'ie10':$intern_8, 'ie8':$intern_63, 'ie9':$intern_64, 'safari':$intern_65};
    ...
    if (isHostedMode()) {
      return computeUrlForResource($intern_67);
    }
    var strongName;
    try {
      unflattenKeylistIntoAnswers([$intern_50, $intern_62], $intern_68);
      unflattenKeylistIntoAnswers([$intern_49, $intern_62], $intern_68 + $intern_69);
      unflattenKeylistIntoAnswers([$intern_50, $intern_53], $intern_68 + $intern_70);
      strongName = answers[computePropValue($intern_46)][computePropValue($intern_51)];
