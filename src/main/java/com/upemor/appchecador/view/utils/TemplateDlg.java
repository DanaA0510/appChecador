...
public abstract class TemplateDlg<T> extends Panel{
    ...
    private void initDlg(){
        ...
        grid = new Grid<>("<h2><b>Resultados encontrados</b></h2>");
            ...
            grid.addComponentColumn(this::buildDeleteButton).setMaximumWidth(50);
    ...
    private Button buildEditButton(T obj){
        Button button = new Button(VaadinIcons.EDIT);
            ...
            button.setDescription("gridEditButtonDescription");
            button.addClickListener(e -> eventEditButtonGrid(obj));
        return button;
    }

    private Button buildDeleteButton(T obj){
        Button button = new Button(VaadinIcons.TRASH);
            button.addStyleName(ValoTheme.BUTTON_DANGER);
            button.setDescription("gridDeleteButtonDescription");
            button.addClickListener(e -> eventDeleteButtonGrid(obj));
        return button;
    }
