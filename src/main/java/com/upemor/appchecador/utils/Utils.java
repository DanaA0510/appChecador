 ...
 */
package com.upemor.appchecador.utils;
...
public class Utils{
    ...
    public static boolean verifyEmailPattern(String email) throws Exception{
        Pattern pattern = Pattern.compile("(\\W|^)[\\w.\\-]{0,25}@(hotmail|gmail|tiamex)\\.(com|.com.mx)(\\W|$)");
    ...
    public static boolean verifyLenghtPassword(String password) throws Exception{
        if(password.length()<8){throw new Exception("La contraseña debe tener minimo 8 caracteres");}
        return true;
    }
    
    /*Verificacion de email*/
    public static boolean validateExtendFile(String file) throws Exception{
        Pattern pattern = Pattern.compile("(\\W|^)[\\w.\\-]{0,25}\\.(sql)(\\W|$)");
